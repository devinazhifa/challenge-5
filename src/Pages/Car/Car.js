...
const Car = (props) => {
  ...
  const carCart = useSelector((store) => store.carSlice.carCart);
        ...
        <>
              ...
              <div className="details-container-right">
                <div className="details-container-right-inner">
                  ...
                  <button
                    ...
                    onClick={() =>
                      dispatch(
                        carSlice.actions.addCarToCart({ id: car.id })
                      )
                    }
                  >
          ...
          <div className="button-center-container-outer">
            <button
              ...
              disabled={carCart === car.id}
              onClick={() =>
                dispatch(carSlice.actions.addCarToCart({ id: car.id }))
              }
            >
